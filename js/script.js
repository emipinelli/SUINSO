...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Offset específico para el about us'
    ...
    specificLink.addEventListener('click', function (e) {
        ...
        if (targetElement) {
            const SPECIFIC_OFFSET = 35; // Offset específico para la sección 2
    ...
    Servicios.addEventListener('click', function (e) {
        ...
        if (targetElement) {
            const SPECIFIC_OFFSET = 30; // Offset específico para la sección 2
            const targetPosition = targetElement.getBoundingClientRect().top + window.pageYOffset - SPECIFIC_OFFSET;
